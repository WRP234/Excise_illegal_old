import { Types } from './investigate.model';

export interface InvestigateStaff {
    STAFF_ID?: number;
    ARREST_ID?: number;
    STAFF_REF_ID?: number;
    TITLE_ID?: number;
...
export const InvestigateStaffVariable: InvestigateStaff = {
    STAFF_ID: null,
    ARREST_ID: null,
    STAFF_REF_ID: null,
    TITLE_ID: null,
...
export interface InvestigateStaffupdDelete {
    STAFF_ID: number;
}
...
export const CONTRIBUTOR_ID: Types[] = [
    { value: 14, text: 'ผู้จับ' },
    { value: 15, text: 'ผู้ร่วมจับ' }
]


export const InvestigateStaffMock: any[] = [
    {
        "STAFF_ID": 92,
        "TITLE_ID": 3,
        "STAFF_CODE": "6373",
