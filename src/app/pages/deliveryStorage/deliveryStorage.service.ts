...
import { DeliveryStorageEvidenceIn } from './deliveryStorage';
...
export class DeliveryStorageService {
  ...
  async getByKeyword(Textsearch: any): Promise<any> {
    ...
    const url = `${appConfig.api1111}/DeliverstorageListgetByKeyword`;
  ...
  async getByConAdv(form: any): Promise<any> {
    ...
    const url = `${appConfig.api1111}/DeliverstorageListgetByConAdv`;
  ...
  async getDeliverStoragegetByCreate(form: any): Promise<any> {
    const params = JSON.stringify(form);
    const url = `${appConfig.api1111}/DeliverStoragegetByCreate`;
  ...
  async getDeliverStoragegetProduct(form: any): Promise<any> {
    const params = JSON.stringify(form);
    const url = `${appConfig.api1111}/DeliverStorageetProduct`;
  ...
  async DeliveryStorageinsAll(req: DeliveryStorageEvidenceIn): Promise<any> {
    const params = JSON.stringify(req);
    const url = `${appConfig.api1111}/DeliveryStorageinsAll`;
  ...
  async DeliverStorageupdByCon(req: DeliveryStorageEvidenceIn): Promise<any> {
    const params = JSON.stringify(req);
    const url = `${appConfig.api1111}/DeliverStorageupdByCon`;
  ...
  async DeliverStoragegetByCon(form: any): Promise<any> {
    const params = JSON.stringify(form);
    const url = `${appConfig.api1111}/DeliverStoragegetByCon`;
  ...
  async DeliverStorageupdDelete(form: any): Promise<any> {
    const params = JSON.stringify(form);
    const url = `${appConfig.api1111}/DeliverStorageupdDelete`;
