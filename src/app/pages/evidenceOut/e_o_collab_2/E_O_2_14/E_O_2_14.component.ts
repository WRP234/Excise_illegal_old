...
@Component({
  selector: 'app-E_O_2_14',
  templateUrl: './E_O_2_14.component.html',
  styleUrls: ['./E_O_2_14.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class E_O_2_14_Component extends ManageConfig implements OnInit {
