...
@Component({
  selector: 'app-E_O_2_12',
  templateUrl: './E_O_2_12.component.html',
  styleUrls: ['./E_O_2_12.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})

export class E_O_2_12_Component extends ManageConfig implements OnInit {
