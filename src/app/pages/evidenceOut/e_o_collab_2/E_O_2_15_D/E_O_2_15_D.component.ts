...
@Component({
  selector: 'app-E_O_2_15_D',
  templateUrl: './E_O_2_15_D.component.html',
  styleUrls: ['./E_O_2_15_D.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class E_O_2_15_D_Component extends ManageConfig implements OnInit {
