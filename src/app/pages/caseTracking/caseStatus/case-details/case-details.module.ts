...
const routes: Routes = [
    {
        ...
        data: {
            // title: 'ค้นหาข้อมูล',
            urls: [{ title: 'หน้าหลัก', url: '/' },{ title: 'ค้นหางานติดตามสถานะคดี', url: '/caseStatus/list' }, { title: 'ค้นหางานติดตามสถานะคดี', url: '/caseStatus/case-details' }], 
            // nextPage: { title: 'xxx', url: '/masProducts/list' },
            codePage: 'ILG60_O_10_01_02_00'
        },
