...
export class ListComponent implements OnInit, OnDestroy {
    ...
    clickView(masterID: string) {
        this._router.navigate([`/msProductUnit/manage/R/${masterID}`]);
    }

    clickNew = () => this._router.navigate([`/msProductUnit/manage/C/NEW`]);
    ...
    clickSearch(Textsearch: any) {
        ...
        this.MasService.getByKeyword("MasProductUnitgetByKeyword", paramsOther).then(list => {
            if(list.SUCCESS){
