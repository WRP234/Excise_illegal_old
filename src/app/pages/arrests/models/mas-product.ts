...
export interface ProductSRP {
    ...
    BrandMainEng: string;
    BrandMainTha: string;
    BrandSecondCode: string;
    BrandSecondNameEng: string;
    BrandSecondNameTha: string;
    Co2Quantity: string;
    CompanyName: string;
    Degree: string;
    DegreeCode: string;
...
export interface IMasProductGroup {
    ...
    UPDATE_DATE: Date;
    UPDATE_USER_ACCOUNT_ID: number;
    PRODUCT_GROUP_CODE_OLD1?: string;
    PRODUCT_GROUP_CODE_OLD2?: string;
    PRODUCT_GROUP_CODE_OLD3?: string;
}
...
// export interface IMasProductGroupCategory {
//     PRODUCT_GROUP_ID: number;
//     PRODUCT_GROUP_CODE: string
//     PRODUCT_GROUP_NAME: string
//     IS_ACTIVE: number;
...
export interface IMasProductGroupCategorygetByCon {
    CATEGORY_GROUP: string;
    PRODUCT_CODE: string;
}

export interface IMasProductGROUPCategoryForLiquor {
    PRODUCT_GROUP_ID: number;
    PRODUCT_GROUP_CODE: string;
    PRODUCT_GROUP_NAME: string;
    PRODUCT_CATEGORY_ID: number;
...
export interface IMasProductGROUPCategoryForLiquorgetByCon {

}

export interface IMasProductCategoryGroup {
    PRODUCT_CODE: string;
    CATEGORY_GROUP: string;
    CATEGORY_GROUP_DESC: string;
    IS_ACTIVE: number;
...
export interface IMasProductCategoryRDB {
    PRODUCT_CODE: string;
...
export interface IMasProductCategoryRDBgetByCon {
    PRODUCT_CODE: string;
    CATEGORY_GROUP: string;
}
