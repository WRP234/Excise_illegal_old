...
import { ArrestLawbreaker, ArrestLawbreakerupdDelete, ArrestLawbreakerinsAllResponse } from "../models";
...
export class ArrestLawbreakerService extends ArrestHelperService {
    ...
    ArrestLawbreakerinsAll(form: ArrestLawbreaker[]): Observable<any> {
        return this.http
            .post<ArrestLawbreakerinsAllResponse>(`${this.ArrestApiPrefixUrl}/ArrestLawbreakerinsAll`, form);
    }
