export const Message = {
    ...
    saveFail_plsContactAdm: 'บันทึกข้อมูลไม่สำเร็จ กรุณาติดต่อผู้ดูแลระบบ',
    ...
    delStaffComplete: 'ลบข้อมูลผู้ร่วมทำการสืบสวนสำเร็จ',
    delStaffFail: 'ลบข้อมูลผู้ร่วมทำการสืบสวนสำเร็จไม่สำเร็จ',
    ...
    delLocaleComplete: 'ลบข้อมูลสถานที่ทำการสืบสวนสำเร็จ',
    delLocaleFail: 'ลบข้อมูลสถานที่ทำการสืบสวนไม่สำเร็จ',
    ...
    checkStaff: 'กรุณากรอกข้อมูลเจ้าหน้าที่',
    checkLocale: 'กรุณากรอกข้อมูลเจ้าบ้าน/ผู้ดูแลแทน',
    // checkGuiltbase : 'กรุณากรอกข้อมูลฐานความผิด'
    cannotDelItemIndictUsing: 'ไม่สามารถลบข้อมูลได้ กรุณาลบข้อมูลข้อกล่าวหาที่อ้างอิง',

    RevenueIncFail: 'ไม่สามารถบันทึกข้อมูลได้ นำส่งรายได้ไม่สำเร็จ',
